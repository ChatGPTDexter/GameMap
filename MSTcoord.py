...
class ClusterCreator:
    ...
    def load_skills_data_from_csv(self, csv_file):
        ...
        column = 'Transcript'  # Use only the 'Transcript' column for embeddings
        ...
        try:
            ...
            # Remove None embeddings and corresponding entries
    ...
    def make_clusters(self):
        ...
        umap_coords = umap_model.fit_transform(embedding_array) * 500  # Scale UMAP coordinates by 500
    ...
    def save_umap_coords_to_csv(self, output_file):
        umap_coords_df = self.workbench[['Label', 'umap_coords']]
